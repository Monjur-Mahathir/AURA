...
int main(int argc, char * argv[]) try
{
    ...
    while (waitKey(1) < 0)
    {
        ...
        rs2::frame depth = data.get_depth_frame().apply_filter(colormap);
        ...
        Mat image_depth(Size(w1, h1), CV_8UC3, (void*)depth.get_data(), Mat::AUTO_STEP);
        Mat image_rgb(Size(w2, h2), CV_8UC3, (void*)rgb.get_data(), Mat::AUTO_STEP);
